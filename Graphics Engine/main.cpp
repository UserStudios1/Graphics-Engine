...
int main() {
	...
	*/
	...
	// generate VBO (Vertex Buffer Object) and VAO (Vertex Array Object) and Element Buffer Object (EBO)
	...
	*/
	...
	while (!glfwWindowShouldClose(window)) {
		...
		view = glm::translate(view, glm::vec3(0.0f, 0.0f, -3.0f)); // translate scene in reverse direction
